...
class StructuredLogger(val logger: Logger) : Logger {
    ...
    override fun info(marker: Marker?, msg: String?) = run { logger.info(appendEntries(attributes).and(marker), msg) }
    override fun info(marker: Marker?, format: String?, arg: Any?) = run { logger.info(appendEntries(attributes).and(marker), format, arg) }
    override fun info(marker: Marker?, format: String?, arg1: Any?, arg2: Any?) = run { logger.info(appendEntries(attributes).and(marker), format, arg1, arg2) }
    override fun info(marker: Marker?, format: String?, vararg arguments: Any?) = run { logger.info(appendEntries(attributes).and(marker), format, arguments) }
    override fun info(marker: Marker?, msg: String?, t: Throwable?) = run { logger.info(appendEntries(attributes).and(marker), msg, t) }
    ...
    override fun warn(marker: Marker?, msg: String?) = run { logger.warn(appendEntries(attributes).and(marker), msg) }
    override fun warn(marker: Marker?, format: String?, arg: Any?) = run { logger.warn(appendEntries(attributes).and(marker), format, arg) }
    override fun warn(marker: Marker?, format: String?, arg1: Any?, arg2: Any?) = run { logger.warn(appendEntries(attributes).and(marker), format, arg1, arg2) }
    override fun warn(marker: Marker?, format: String?, vararg arguments: Any?) = run { logger.warn(appendEntries(attributes).and(marker), format, arguments) }
    override fun warn(marker: Marker?, msg: String?, t: Throwable?) = run { logger.warn(appendEntries(attributes).and(marker), msg, t) }
    ...
    override fun error(marker: Marker?, format: String?, arg: Any?) = run { logger.error(appendEntries(attributes).and(marker), format, arg) }
    override fun error(marker: Marker?, format: String?, arg1: Any?, arg2: Any?) = run { logger.error(appendEntries(attributes).and(marker), format, arg1, arg2) }
    override fun error(marker: Marker?, format: String?, vararg arguments: Any?) = run { logger.error(appendEntries(attributes).and(marker), format, *arguments) }
    override fun error(marker: Marker?, msg: String?, t: Throwable?) = run { logger.error(appendEntries(attributes).and(marker), msg, t) }
    ...
    override fun debug(marker: Marker?, msg: String?) = run { logger.debug(appendEntries(attributes).and(marker), msg) }
    override fun debug(marker: Marker?, format: String?, arg: Any?) = run { logger.debug(appendEntries(attributes).and(marker), format, arg) }
    override fun debug(marker: Marker?, format: String?, arg1: Any?, arg2: Any?) = run { logger.debug(appendEntries(attributes).and(marker), format, arg1, arg2) }
    override fun debug(marker: Marker?, format: String?, vararg arguments: Any?) = run { logger.debug(appendEntries(attributes).and(marker), format, *arguments) }
    override fun debug(marker: Marker?, msg: String?, t: Throwable?) = run { logger.debug(appendEntries(attributes).and(marker), msg, t) }
    ...
    override fun trace(marker: Marker?, format: String?, arg1: Any?, arg2: Any?) = run { logger.trace(appendEntries(attributes).and(marker), format, arg1, arg2) }
    override fun trace(marker: Marker?, format: String?, vararg argArray: Any?) = run { logger.trace(appendEntries(attributes).and(marker), format, *argArray) }
    override fun trace(marker: Marker?, msg: String?, t: Throwable?) = run { logger.trace(appendEntries(attributes).and(marker), msg, t) }
